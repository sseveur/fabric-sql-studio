...
function BqTable({ fetchRows, exportRef, schema, totalRows, initialRows, title, dmlStats, statementType, rowsAffected, onExport = postExport }) {
    ...
    const [colFilter, setColFilter] = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_1__.useState)('');
    ...
    const visibleColumns = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => {
    ...
    return ((0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { class: "bq-root", style: cssVars, children: [title && (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { class: "bq-title", children: title }), showDml && ((0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { class: "bq-dml-summary", children: [(0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", { class: "bq-dml-type", children: statementType || 'DML' }), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", { class: "bq-dml-counts", children: dmlParts.length ? dmlParts.join(' · ') : '0 rows affected' })] })), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { class: "bq-toolbar", children: [(0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { class: "bq-controls bq-controls-tabs", children: (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { class: "bq-tabs", children: [(0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("button", { class: `bq-tab ${tab === 'results' ? 'active' : ''}`, onClick: () => setTab('results'), children: "Results" }), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("button", { class: `bq-tab ${tab === 'schema' ? 'active' : ''}`, onClick: () => setTab('schema'), children: ["Schema ", (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", { class: "bq-count", children: columns.length })] }), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("button", { class: `bq-tab ${tab === 'chart' ? 'active' : ''}`, onClick: () => setTab('chart'), children: "Chart" })] }) }), (tab === 'results' || (tab === 'schema' && columns.length > 1)) && ((0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { class: "bq-controls bq-controls-2", children: [columns.length > 1 && ((0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", { class: "bq-colfilter", title: "Show only columns whose name matches", children: [(0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("input", { class: "bq-colfilter-input", type: "search", placeholder: "Columns\u2026", value: colFilter, onInput: (e) => setColFilter(e.currentTarget.value) }), colFilter && (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("span", { class: "bq-colfilter-count", children: [visibleColumns.length, "/", columns.length] })] })), tab === 'results' && (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: [(0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("button", { class: "bq-pg-btn", disabled: pageIndex === 0 || loading, onClick: () => setPageIndex(0), title: "First page", children: "\u00AB" }), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("button", { class: "bq-pg-btn", disabled: pageIndex === 0 || loading, onClick: () => setPageIndex(p => Math.max(0, p - 1)), title: "Previous page", children: "\u2039" }), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", { class: "bq-pg-label", children: "Page" }), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("input", { class: "bq-pg-input", type: "number", min: 1, max: totalPages, value: pageIndex + 1, onChange: (e) => {
                                            ...
                                            })] }) }), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("tbody", { children: sortedIndices.map((i, displayIdx) => ((0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", { class: selected.has(i) ? 'bq-selected' : '', onClick: (e) => onRowClick(i, e), onContextMenu: (e) => onRowContextMenu(i, undefined, e), children: [(0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("td", { class: "bq-rownum", onContextMenu: (e) => onRowContextMenu(i, undefined, e), children: startRow + displayIdx }), visibleColumns.map(col => {
...
function SchemaPane({ columns, allColumns }) {
    if (columns.length === 0) {
        return (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { class: "bq-notice", children: "No columns match the filter." });
    }
    return ((0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { class: "bq-scroll", children: (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("table", { class: "bq-grid bq-schema-grid", children: [(0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("thead", { children: (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", { children: [(0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("th", { class: "bq-rownum", children: "#" }), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("th", { children: "Name" }), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("th", { children: "Type" }), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("th", { children: "Mode" })] }) }), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("tbody", { children: columns.map(c => ((0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", { children: [(0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("td", { class: "bq-rownum", children: allColumns.indexOf(c) + 1 }), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("td", { children: c.label }), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("td", { children: (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span", { class: "bq-col-type", children: c.mode === 'REPEATED' ? c.type + '[]' : c.type }) }), (0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("td", { class: "bq-muted", children: c.mode })] }))) })] }) }));
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   GRID_MIME: () => (/* binding */ GRID_MIME),
...
function injectStyles() {
    ...
    const scoped = _resources_grid_v2_css__WEBPACK_IMPORTED_MODULE_3__
        .replace(/(^|\n)[ \t]*body[ \t]*\{[^}]*\}/g, '$1')
...
function activate(context) {
    ...
    if (canMessage && context.onDidReceiveMessage) {
        context.onDidReceiveMessage((msg) => {
            if (!msg || msg.type !== 'bq-page' || !msg.requestId) {
                return;
            }
            const p = pending.get(msg.requestId);
            if (!p) {
    ...
    return {
        renderOutputItem(outputItem, element) {
            ...
            (0,preact__WEBPACK_IMPORTED_MODULE_1__.render)((0,preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(NotebookGrid, { payload: payload, requestPage: requestPage, requestExport: requestExport }), element);
        },
...
const __webpack_exports__GRID_MIME = __webpack_exports__.GRID_MIME;
const __webpack_exports__activate = __webpack_exports__.activate;
export { __webpack_exports__GRID_MIME as GRID_MIME, __webpack_exports__activate as activate };

//# sourceMappingURL=notebook-renderer.js.map